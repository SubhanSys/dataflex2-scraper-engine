DataFlex2 Stock Data Scraper is an advanced desktop application built with Python and CustomTkinter that automates the entire e-commerce data pipeline.

It collects product URLs, scrapes detailed product data using Playwright, processes content with AI (Google Gemini), performs stock analysis, and automatically updates inventory and pricing via the Trendyol API.
